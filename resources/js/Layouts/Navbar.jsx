...
function Navbar() {
    ...
    const { auth, products=[], categories=[], category=null } = usePage().props;
                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            {auth.user ? (
                                ...
                                <Link href={route('login.user')} className="text-gray-600 flex flex-col items-center">
                                    <CircleUser className="h-5 w-5" />
                                    <span>Guest</span>
                                </Link>
                            )}
                ...
                <nav className="bg-gray-100 border-t hidden md:block">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-12 flex items-center justify-between text-sm">
                        <div className="flex space-x-6">
                            ...
                            {(categories || []).map(link => (
                                <Link key={link.id} href={route('category.product', link.id)} className="text-gray-700 hover:text-blue-600 font-medium">
                                    {link.category_name}
                                </Link>
                            ))}
                        </div>
